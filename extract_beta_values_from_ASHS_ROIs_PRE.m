...
for subj = subjects
    ...
    for r = 1:length(roi_suffixes)
        ...
        for i = 1:length(commercialNames)
            ...
            roi_combined_beta_values_PRE = ...
                [roi_combined_beta_values_PRE, trial_beta_values];
        ...
        save(beta_save_name, 'roi_combined_beta_values_PRE');

        % Save correlation matrix
        if size(roi_combined_beta_values_PRE, 2) > 1

            correlation_matrix = corr(roi_combined_beta_values_PRE, ...
                'rows', 'pairwise');
