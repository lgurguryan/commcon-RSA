...
for i = 1:length(commercialNames{1})
    ...
    for subj = subjects
        ...
        niiFiles = dir(fullfile(fileDir, ['sub-' subjID '_task-commpost_run-*_space-MNI152NLin2009cAsym_desc-preproc_bold.nii']));
        ...
        resultDir = fullfile('/Volumes/BrusselsGriffon/CommCon/SPM_results/Model3_POST', ['Model3_sub-' subjID], commercialName);
        
        % Define behavioral timing file 
        timingFile = fullfile('/Users/yorkie/Documents/CommCon/data/raw_behavioral/Model3', commercialName, ['sub_' subjID '_' commercialName '_TimingFile_M3_POST.mat']);
        
        % Define the confounds file 
        confoundsFile = fullfile('/Volumes/BrusselsGriffon/CommCon/derivatives/fmriprep', ['sub-' subjID], 'func', ['sub-' subjID '_confounds_POST.txt']);
